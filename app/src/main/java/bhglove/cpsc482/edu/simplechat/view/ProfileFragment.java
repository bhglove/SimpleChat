...
public class ProfileFragment extends Fragment {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == TakePhoto.REQUEST_PERMISSIONS && resultCode == Activity.RESULT_OK) {
            mParam1 = data.getStringExtra(TakePhoto.RECEIVE_PHOTO);
            if(mParam1 != null){
               ImageView view = (ImageView) getActivity().findViewById(R.id.imageView3);
               if(view != null){
                   CachePhotos cachePhotos = CachePhotos.getInstance();
                   cachePhotos.loadBitmap(mParam1, view);
               }
            }
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivityForResult(intent, TakePhoto.REQUEST_PERMISSIONS);
            }
        });
        return view;
    }
